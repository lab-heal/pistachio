# PISTACHIo 2.0 (PreemptIon of diSrupTive behAvior in CHIldren)

Model training and analysis code for PISTACHIo 2.0.

PISTACHIo 2.0 is a machine learning application that uses physiological biomarkers, including heart rate and sleep quality, collected by wearables, such as smartwatches, to predict disruptive behavior in children.
